        ...
        <div class="card">
            ...
            <form id="tds-form">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="question" name="question" placeholder="Type your question here..." rows="6" required></textarea>
                </div>
                <div class="mb-3">
                    <label for="file" class="form-label">Upload File (Optional):</label>
                    <input type="file" class="form-control" id="file" name="file" accept=".png,.json,.jsonl,.pdf,.xlsx,.csv,.zip,.jpg,.jpeg,.txt,.md,.webp">
                </div>
